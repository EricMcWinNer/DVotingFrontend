...
import registration from "assets/img/icons/add-officer.png";
...
function RegisterOfficerRouteView(props) {
  return (
    <div
            ...
            <div className="card lg-padding b-100">
              <div className="clearfix o-auto">
                ...
                <h2 className={"cartogothic boldHeader float-left"}>
                  Electoral Officer Registration
                </h2>
              </div>
              ...
              <RegisterForm
                url={`${process.env.REACT_APP_API_PATH}/api/web/auth/officer/register`}
...
export default RegisterOfficerRouteView;
